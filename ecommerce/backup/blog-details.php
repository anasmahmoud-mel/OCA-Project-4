...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/blog-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:05:56 GMT -->
<head>
...
<body>
                    ...
                    <div class="col-sm-6">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="index-2.php">blog</a></li>
    ...
    <section class="blog-detail-page section-b-space ratio2_3">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 blog-detail"><img src="./images/about/about%20us.jpg"
                        class="img-fluid blur-up lazyload" alt="">
            ...
            <div class="row section-b-space blog-advance">
                <div class="col-lg-6">
                    <div><img src="./images/blog/1.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></div>
                </div>
                <div class="col-lg-6">
                    <div><img src="./images/blog/2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></div>
                </div>
                <div class="col-lg-6">
                    <ul>
            ...
            <div class="row section-b-space">
                <div class="col-sm-12">
                    <ul class="comment-section">
                        <li>
                            <div class="media"><img src="./images/avtar.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media"><img src="./images/2.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                                        fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer
                        ...
                        <li>
                            <div class="media"><img src="./images/20.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                                        fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer
