...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/forget_pwd.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:05:09 GMT -->
<head>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="email" placeholder="Enter Your Email"
                                    required="">
                            </div><a href="#" class="btn btn-solid">Submit</a>
                        </div>
                    </form>
                </div>
            </div>
