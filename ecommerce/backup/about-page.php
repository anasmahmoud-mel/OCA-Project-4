...
<body>
                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index-2.php"><img src="./images/icon/logo.gif"
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="./images/about/about%20us.jpg"
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="./images/team/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                        ...
                        <div>
                            <div>
                                <img src="./images/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="./images/team/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="./images/team/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                ...
                                <li><a href="#"><img src="./images/icon/paypal.png" alt=""></a></li>
                                <li><a href="#"><img src="./images/icon/american-express.png" alt=""></a></li>
                                <li><a href="#"><img src="./images/icon/discover.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/about-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:05:30 GMT -->
</html>