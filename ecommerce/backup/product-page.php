...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/product-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:02:59 GMT -->
<head>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index-2.php"><img src="./images/icon/logo.gif"
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a target="_blank"
                                                                href="marketplace-demo.php">marketplace</a></li>
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="element-slider.php">home
                                                                                    slider</a></li>
                                                                            <li><a
                                                                                    href="element-category.php">category</a>
                                                                            </li>
                                                                            <li><a
                                                                                    href="element-service.php">service</a>
                                                                            </li>
                                                            ...
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li class="up-text"><a
                                                                                    href="element-productbox.php">product
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 collection-filter">
                        ...
                        <!-- side-bar single product slider start -->
                        <div class="theme-card">
                            <h5 class="title-border">new games</h5>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                ...
                                                href="product-page(no-sidebar).php">
                                                <h6><!-- Item name --></h6>
                                            </a>
                                            <h4><!-- Item price --></h4>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        <div><img src="./images/pro3/1.jpg" alt=""
                                                class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                                        <div><img src="./images/pro3/2.jpg" alt=""
                                                class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                                        <div><img src="./images/pro3/27.jpg" alt=""
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="./images/pro3/33.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="./images/pro3/34.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="./images/pro3/1.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="./images/pro3/2.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="./images/pro3/27.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="./images/pro3/28.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="./images/pro3/35.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="./images/pro3/36.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
            ...
            <div class="setting-body">
                            ...
                            <div class="set-position">
                                ...
                                <div class="demo-text">
                                    ...
                                    <div class="btn-group demo-btn" role="group" aria-label="Basic example"> <button
                                            type="button" onClick="window.open('index-2.php')"
                ...
                <div class="buy_btn">
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                        target="_blank" class="btn btn-block purchase_btn"><img src="./images/icon/angular.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                        target="_blank" class="btn btn-block purchase_btn"><img src="./images/icon/react.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><img src="./images/icon/shopify.png"
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="img-fluid blur-up lazyload pro-img"
                                                src="./images/fashion/product/43.jpg" alt="">
                                        </a>
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="upsell_payment">
                                                <img src="./images/payment_cart.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row" id="upsell_product">
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="./images/fashion/product/1.jpg"
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="./images/fashion/product/34.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="./images/fashion/product/13.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="./images/fashion/product/19.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/product-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:03:06 GMT -->
</html>