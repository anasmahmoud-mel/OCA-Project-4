                    ...
                    <div class="row product-page-main card-body">
                        <div class="col-xl-4">
                            <div class="product-slider owl-carousel owl-theme" id="sync1">
                                <div class="item"><img src="./images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                                <div class="item"><img src="./images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                                ...
                                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"><img src="./images/size-chart.jpg" alt="" class="img-fluid blur-up lazyloaded"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="size-box">
