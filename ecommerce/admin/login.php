...
if(isset($_POST['submit'])){
   ...
   if(!empty($Email) && !empty($Password)){
     ...
     if(!empty ($row)){
         // Enable Session if the Value is true.
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:20:31 GMT -->
<head>
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to Loading dashboard!</h3>
                                    <p>Please login if you are the admin of this website.</p>
                                </div>
                            </div>
                            <div>
                            </div>
...
<script src="./js/jsgrid/griddata-invoice.js"></script>
<script src="./js/jsgrid/jsgrid-invoice.js"></script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:20:34 GMT -->
</body>

<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 14:20:34 GMT -->
</html>
